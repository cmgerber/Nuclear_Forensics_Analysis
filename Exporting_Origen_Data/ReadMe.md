...
5. Once you reapeat this process for all of the reactor types you plan to export from Origen you can run the [Combining_Excel.ipynb notebook](http://nbviewer.ipython.org/urls/raw.githubusercontent.com/cmgerber/Nuclear_Forensics_Cluster_Analysis/master/Exporting_Origen_Data/Combining_Excel.ipynb?create=1) to combine all of the excel files you created into one summary excel file. You can then use this excel file for analysis.
